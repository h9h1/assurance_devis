...
var _dirname = (0, import_node_path2.dirname)((0, import_node_url2.fileURLToPath)(import.meta.url));
var refreshRuntimePath = (0, import_node_path2.join)(_dirname, "refresh-runtime.js");
var babel;
async function loadBabel() {
  if (!babel) babel = await import("./lib-4RADUD5X.js");
  return babel;
}
...
function viteReact(opts = {}) {
  ...
  const viteReactRefresh = {
    ...
    load: {
      filter: { id: exactRegex(runtimePublicPath) },
      handler(id) {
        if (id === runtimePublicPath) return (0, import_node_fs2.readFileSync)(refreshRuntimePath, "utf-8").replace(/__README_URL__/g, "https://github.com/vitejs/vite-plugin-react/tree/main/packages/plugin-react");
      }
    },
